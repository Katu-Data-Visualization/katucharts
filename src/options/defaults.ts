...
export const defaultOptions: KatuChartsOptions = {
  ...
  xAxis: {
    type: 'linear',
    title: { text: null, style: { fontSize: DEFAULT_CHART_TEXT_SIZE } },
    labels: {
      enabled: true,
      style: { fontSize: DEFAULT_CHART_TEXT_SIZE },
      autoRotation: [-45],
  ...
  legend: {
    ...
    itemMarginBottom: 0,
    itemDistance: 20,
    itemStyle: { cursor: 'pointer', fontSize: DEFAULT_CHART_TEXT_SIZE, fontWeight: 'normal' },
  ...
  plotOptions: {
    ...
    dependencywheel: { dataLabels: { enabled: true }, showInLegend: false },
    treegraph: { dataLabels: { enabled: true }, showInLegend: false },
