/**
 * Minimal synchronous SHA-256 and HMAC-SHA-256 implementation.
 * No external dependencies — used exclusively by LicenseManager.
 */
...
function sha256(message: Uint8Array): Uint8Array {
  ...
  const padded = new Uint8Array(totalLen + padLen);
  padded.set(message);
  padded[msgLen] = 0x80;

  // write bit length as 64-bit big-endian (only lower 32 bits needed for our use case)
