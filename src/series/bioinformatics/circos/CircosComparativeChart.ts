...
export class CircosComparativeChart extends BaseSeries {
  ...
  render(): void {
    ...
    /**
     * Chromosome labels rendered last so they sit on top of
     * species arcs rather than being occluded by them.
     */
  ...
  private renderCleanLabels(
    ...
    const labels = group.selectAll('.katucharts-comp-label')
      ...
      .attr('text-anchor', (d: ChromosomeArc) => {
        const midAngle = (d.startAngle + d.endAngle) / 2;
        const angleDeg = midAngle * 180 / Math.PI - 90;
